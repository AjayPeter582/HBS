...
// Initialize favourites in session if not set
if (!isset($_SESSION['favourites'])) {
    $_SESSION['favourites'] = [];
}

// Get favourite product details dynamically
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['remove_fav'])) {
    ...
    $_SESSION['favourites'] = array_diff($_SESSION['favourites'], [$product_id]); // Remove from session
    header("Location: favourite.php"); // Refresh page
    exit;
}
?>
