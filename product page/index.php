...
// Initialize cart and favourites in session if not set
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    ...
    if ($product) {
        if (isset($_SESSION['cart'][$product_id])) {
            $_SESSION['cart'][$product_id]['quantity'] += 1; // Increase quantity if already in cart
        } else {
...
// Handle increase, decrease, and remove from cart
...
// Handle add to favourites (unchanged)
